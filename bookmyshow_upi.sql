...
CREATE TABLE `upi` (
  ...
  `UPI_ID` varchar(300) DEFAULT NULL,
  `id` int NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`),
  KEY `User_id` (`User_id`),
  CONSTRAINT `upi_ibfk_1` FOREIGN KEY (`User_id`) REFERENCES `user_detial` (`User_ID`)
...
INSERT INTO `upi` VALUES (3,'Gpay','kannan8787',1),(2,'Phonepe','girithar2345',2);
